-- Insert E-commerce Dummy Data
-- This script inserts comprehensive dummy data for dashboard analytics
...
SELECT 
    ...
    LOWER(first_names.first_name || '.' || last_names.last_name || i || '@example.com') as email,
...
-- Insert products (100 products across all categories)
...
-- Insert orders (5000 orders over the last year)
...
-- Insert reviews (30% of orders have reviews)
